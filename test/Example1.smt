...
(assert (= t11 (mk-type false empty) ))
(assert (= t9 (prod t10 t11 )))
(assert (= t12 (mk-type false empty) ))
(assert (= t1 (sum t9 t12 )))
(assert (= t13 (mk-type false empty) ))
(assert (= t14 (mk-type false empty) ))
(assert (= t2 (prod t13 t14 )))
(assert (not (member A t0 )))
 (assert (= t16 (mk-type (is-null t0 ) (union (singleton A ) (head-set  t0 )))))
(assert (= t17 (mk-type false empty) ))
(assert (= t15 (prod t16 t17 )))

...
data HappyAbsSyn t12 t13
	...
	| HappyAbsSyn4 (Grammar)
	| HappyAbsSyn5 ([(String, Expr)])
	| HappyAbsSyn6 ((String,Expr))
	| HappyAbsSyn7 (Expr)
	| HappyAbsSyn12 t12
	| HappyAbsSyn13 t13

happyExpList :: Happy_Data_Array.Array Prelude.Int Prelude.Int
happyExpList = Happy_Data_Array.listArray (0,58) ([0,0,0,0,16,0,0,32,0,0,0,2048,8192,100,128,8192,100,0,0,1,0,8192,100,25632,0,0,0,8192,100,640,0,0,192,0,0,0,8192,100,25632,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parser","grammar","rules","rule","expr","term","nfactor","factor","atom","many__rule__","many_rev__rule__","'('","')'","'/'","'*'","';'","'!'","'-->'","'@start:'","var","string","%eof"]
...
action_10 (9) = happyGoto action_23
...
action_15 (9) = happyGoto action_20
...
action_18 (8) = happyGoto action_10
action_18 (9) = happyGoto action_11
...
action_25 (9) = happyGoto action_23
...
happyReduction_1 (HappyAbsSyn7  happy_var_3)
	...
	(HappyAbsSyn5  happy_var_1)
	 =  HappyAbsSyn4
		 (Grammar happy_var_1 happy_var_3
	)
...
happyReduction_3 (_ `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn6
		 ((var2Str happy_var_1, happy_var_3)
	) `HappyStk` happyRest
...
happyError' tk = (\(tokens, _) -> error tokens) tk
...
mkString :: Token -> Expr 
mkString (TSym s@(_ : _)) = foldr1 ((:@:) . Chr) s
